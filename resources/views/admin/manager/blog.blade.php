...
@section('title', 'Blog')
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="manager-group | blog">
@endsection()
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="form-control data-description summernote" name="" id="" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>  
                                    </div> 
                                </div>
